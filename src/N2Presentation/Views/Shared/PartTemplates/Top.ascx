<%@ Control Language="C#" AutoEventWireup="true" Inherits="System.Web.Mvc.ViewUserControl<N2Presentation.Models.Parts.Top>" %>
<%@ Import Namespace="N2Presentation.Models.Parts"%>
<div class="uc">
