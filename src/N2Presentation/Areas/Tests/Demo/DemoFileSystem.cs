...
namespace N2Presentation.Areas.Tests.Demo
{
	//<components>
	//    <add service="N2.Edit.FileSystem.IFileSystem, N2" implementation="N2Presentation.Areas.Tests.Demo.DemoFileSystem, N2Presentation" />
	//</components>
